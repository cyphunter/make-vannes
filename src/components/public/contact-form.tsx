    ...
    return (
      ...
      >
        ...
        <p className="mt-2 text-muted">
          Merci ! Nous vous répondrons sous deux jours ouvrés. À très vite à la boutique.
        </p>
      </div>
    );
  }
    ...
    <form action={handleSubmit} className="space-y-5" noValidate>
      ...
      <div>
        ...
        <Textarea
          ...
          className="mt-2"
          placeholder="Date, nombre de personnes, atelier souhaité, contexte… plus c'est précis, mieux c'est."
        />
        {errors.message ? (
      ...
      <div className="flex items-start gap-3 rounded-xl bg-paper-warm p-4 ring-1 ring-ink/8">
        <input
          id="consent"
          name="consent"
          type="checkbox"
        ...
        <Label htmlFor="consent" className="text-sm font-normal text-muted">
          ...
          <a href="/confidentialite" className="text-brand link-craft">
      ...
      <div className="flex items-center justify-between gap-4">
        <p className="text-xs text-muted">
          Nous vous répondons sous 48h ouvrées à {siteConfig.contact.email}.
        </p>

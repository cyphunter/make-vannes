...
export function InfoPratique() {
  return (
    <section
      ...
      className="relative overflow-hidden rounded-3xl bg-deep p-10 text-paper md:p-14 noise-overlay"
    >
      <div
        aria-hidden="true"
      ...
      <div className="relative">
        <p className="eyebrow !text-gold">Venir nous voir</p>
        <h2
        ...
        >
          30 rue Saint-Patern,
          <br />
          <span className="ital-mark !text-gold">on vous attend.</span>
        </h2>
          ...
          <InfoItem
            ...
            value={
              <a
                ...
                className="link-craft hover:text-gold"
              >
                {siteConfig.contact.email}
              </a>
            }
          />
          {siteConfig.contact.phoneDisplay !== "À renseigner" ? (
            <InfoItem
              icon={Phone}
              label="Téléphone"
              value={
...
function InfoItem({
  ...
  return (
    <div className="flex items-start gap-4 rounded-2xl bg-paper/5 p-5 ring-1 ring-paper/15 backdrop-blur-sm">
      <span
        className="grid h-11 w-11 shrink-0 place-items-center rounded-xl bg-gold text-deep"
        aria-hidden="true"
      >
